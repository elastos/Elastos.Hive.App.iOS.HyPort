...
@objc public enum SuspendItemLabelPositionType: Int {
    case left
    case right
}

///  Suspend Action Button Object's item.
open class SuspendItem: UIView {
     ...
     */
    @objc open var handler: ((SuspendItem) -> Void)? = nil
    ...
    /**
     Reference to parent
     */
    open weak var actionButton: Suspend?
    ...
    /**
     ...
     deafult is left
     */
    @objc open var titleLabelPosition: SuspendItemLabelPositionType = .left {
        didSet {
    ...
    @objc open var titleLabel: UILabel {
        get {
            if _titleLabel == nil {
                ...
                _titleLabel?.font = SuspendManager.defaultInstance().font
    ...
    fileprivate func createCircleLayer() {
        ...
        let castParent : Suspend = superview as! Suspend
